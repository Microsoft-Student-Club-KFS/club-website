    ...
    <div className='py-16 md:py-24 relative overflow-hidden'>
      ...
      <div className='max-w-6xl mx-auto px-6 relative z-10'>
        <div className='text-center mb-12'>
          ...
          <Body1 className='text-lg opacity-80 max-w-2xl mx-auto'>Access learning materials and resources</Body1>
        </div>
        ...
        <Card className='p-12 text-center backdrop-blur-xl border' style={{
          ...
          <Body1 className='opacity-70'>Resources content will be available soon.</Body1>
        </Card>
      </div>
    </div>
  );
