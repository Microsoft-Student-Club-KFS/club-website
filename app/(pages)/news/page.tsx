  ...
  return (
    <div className='py-16 md:py-24 relative overflow-hidden'>
      <div className='absolute inset-0 overflow-hidden pointer-events-none'>
        <div className='absolute top-20 right-10 w-96 h-96 rounded-full blur-3xl opacity-20' style={{ background: 'linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%)' }} />
        <div className='absolute bottom-20 left-10 w-96 h-96 rounded-full blur-3xl opacity-20' style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #10b981 100%)' }} />
      </div>
      ...
      <div className='max-w-6xl mx-auto px-6 relative z-10'>
        <div className='text-center mb-12'>
          ...
          <Body1 className='text-lg opacity-80 max-w-2xl mx-auto'>Stay updated with the latest news from MSC Club</Body1>
        </div>
        ...
        <Card className='p-12 text-center backdrop-blur-xl border' style={{
          ...
          <Body1 className='opacity-70'>News content will be available soon.</Body1>
        </Card>
      </div>
    </div>
  );
